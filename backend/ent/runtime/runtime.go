...
func init() {
	...
	// accountDescRentalStatus is the schema descriptor for rental_status field.
	accountDescRentalStatus := accountFields[4].Descriptor()
	// account.DefaultRentalStatus holds the default value on creation for the rental_status field.
	account.DefaultRentalStatus = accountDescRentalStatus.Default.(string)
	// accountDescRentalIdentity is the schema descriptor for rental_identity field.
	accountDescRentalIdentity := accountFields[5].Descriptor()
	// account.RentalIdentityValidator is a validator for the "rental_identity" field. It is called by the builders before save.
	account.RentalIdentityValidator = accountDescRentalIdentity.Validators[0].(func(string) error)
