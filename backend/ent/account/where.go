...
// RentalPolicyID applies equality check predicate on the "rental_policy_id" field. It's identical to RentalPolicyIDEQ.
func RentalPolicyID(v int64) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalPolicyID, v))
}

// RentalStatus applies equality check predicate on the "rental_status" field. It's identical to RentalStatusEQ.
func RentalStatus(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalStatus, v))
}

// RentalIdentity applies equality check predicate on the "rental_identity" field. It's identical to RentalIdentityEQ.
func RentalIdentity(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalIdentity, v))
}
...
// RentalPolicyIDEQ applies the EQ predicate on the "rental_policy_id" field.
func RentalPolicyIDEQ(v int64) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalPolicyID, v))
}

// RentalPolicyIDNEQ applies the NEQ predicate on the "rental_policy_id" field.
func RentalPolicyIDNEQ(v int64) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldRentalPolicyID, v))
}

// RentalPolicyIDIn applies the In predicate on the "rental_policy_id" field.
func RentalPolicyIDIn(vs ...int64) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldRentalPolicyID, vs...))
}

// RentalPolicyIDNotIn applies the NotIn predicate on the "rental_policy_id" field.
func RentalPolicyIDNotIn(vs ...int64) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldRentalPolicyID, vs...))
}

// RentalPolicyIDGT applies the GT predicate on the "rental_policy_id" field.
func RentalPolicyIDGT(v int64) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldRentalPolicyID, v))
}

// RentalPolicyIDGTE applies the GTE predicate on the "rental_policy_id" field.
func RentalPolicyIDGTE(v int64) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldRentalPolicyID, v))
}

// RentalPolicyIDLT applies the LT predicate on the "rental_policy_id" field.
func RentalPolicyIDLT(v int64) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldRentalPolicyID, v))
}

// RentalPolicyIDLTE applies the LTE predicate on the "rental_policy_id" field.
func RentalPolicyIDLTE(v int64) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldRentalPolicyID, v))
}

// RentalPolicyIDIsNil applies the IsNil predicate on the "rental_policy_id" field.
func RentalPolicyIDIsNil() predicate.Account {
	return predicate.Account(sql.FieldIsNull(FieldRentalPolicyID))
}

// RentalPolicyIDNotNil applies the NotNil predicate on the "rental_policy_id" field.
func RentalPolicyIDNotNil() predicate.Account {
	return predicate.Account(sql.FieldNotNull(FieldRentalPolicyID))
}

// RentalStatusEQ applies the EQ predicate on the "rental_status" field.
func RentalStatusEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalStatus, v))
}

// RentalStatusNEQ applies the NEQ predicate on the "rental_status" field.
func RentalStatusNEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldRentalStatus, v))
}

// RentalStatusIn applies the In predicate on the "rental_status" field.
func RentalStatusIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldRentalStatus, vs...))
}

// RentalStatusNotIn applies the NotIn predicate on the "rental_status" field.
func RentalStatusNotIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldRentalStatus, vs...))
}

// RentalStatusGT applies the GT predicate on the "rental_status" field.
func RentalStatusGT(v string) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldRentalStatus, v))
}

// RentalStatusGTE applies the GTE predicate on the "rental_status" field.
func RentalStatusGTE(v string) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldRentalStatus, v))
}

// RentalStatusLT applies the LT predicate on the "rental_status" field.
func RentalStatusLT(v string) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldRentalStatus, v))
}

// RentalStatusLTE applies the LTE predicate on the "rental_status" field.
func RentalStatusLTE(v string) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldRentalStatus, v))
}

// RentalStatusContains applies the Contains predicate on the "rental_status" field.
func RentalStatusContains(v string) predicate.Account {
	return predicate.Account(sql.FieldContains(FieldRentalStatus, v))
}

// RentalStatusHasPrefix applies the HasPrefix predicate on the "rental_status" field.
func RentalStatusHasPrefix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasPrefix(FieldRentalStatus, v))
}

// RentalStatusHasSuffix applies the HasSuffix predicate on the "rental_status" field.
func RentalStatusHasSuffix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasSuffix(FieldRentalStatus, v))
}

// RentalStatusEqualFold applies the EqualFold predicate on the "rental_status" field.
func RentalStatusEqualFold(v string) predicate.Account {
	return predicate.Account(sql.FieldEqualFold(FieldRentalStatus, v))
}

// RentalStatusContainsFold applies the ContainsFold predicate on the "rental_status" field.
func RentalStatusContainsFold(v string) predicate.Account {
	return predicate.Account(sql.FieldContainsFold(FieldRentalStatus, v))
}

// RentalIdentityEQ applies the EQ predicate on the "rental_identity" field.
func RentalIdentityEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldRentalIdentity, v))
}

// RentalIdentityNEQ applies the NEQ predicate on the "rental_identity" field.
func RentalIdentityNEQ(v string) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldRentalIdentity, v))
}

// RentalIdentityIn applies the In predicate on the "rental_identity" field.
func RentalIdentityIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldIn(FieldRentalIdentity, vs...))
}

// RentalIdentityNotIn applies the NotIn predicate on the "rental_identity" field.
func RentalIdentityNotIn(vs ...string) predicate.Account {
	return predicate.Account(sql.FieldNotIn(FieldRentalIdentity, vs...))
}

// RentalIdentityGT applies the GT predicate on the "rental_identity" field.
func RentalIdentityGT(v string) predicate.Account {
	return predicate.Account(sql.FieldGT(FieldRentalIdentity, v))
}

// RentalIdentityGTE applies the GTE predicate on the "rental_identity" field.
func RentalIdentityGTE(v string) predicate.Account {
	return predicate.Account(sql.FieldGTE(FieldRentalIdentity, v))
}

// RentalIdentityLT applies the LT predicate on the "rental_identity" field.
func RentalIdentityLT(v string) predicate.Account {
	return predicate.Account(sql.FieldLT(FieldRentalIdentity, v))
}

// RentalIdentityLTE applies the LTE predicate on the "rental_identity" field.
func RentalIdentityLTE(v string) predicate.Account {
	return predicate.Account(sql.FieldLTE(FieldRentalIdentity, v))
}

// RentalIdentityContains applies the Contains predicate on the "rental_identity" field.
func RentalIdentityContains(v string) predicate.Account {
	return predicate.Account(sql.FieldContains(FieldRentalIdentity, v))
}

// RentalIdentityHasPrefix applies the HasPrefix predicate on the "rental_identity" field.
func RentalIdentityHasPrefix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasPrefix(FieldRentalIdentity, v))
}

// RentalIdentityHasSuffix applies the HasSuffix predicate on the "rental_identity" field.
func RentalIdentityHasSuffix(v string) predicate.Account {
	return predicate.Account(sql.FieldHasSuffix(FieldRentalIdentity, v))
}

// RentalIdentityIsNil applies the IsNil predicate on the "rental_identity" field.
func RentalIdentityIsNil() predicate.Account {
	return predicate.Account(sql.FieldIsNull(FieldRentalIdentity))
}

// RentalIdentityNotNil applies the NotNil predicate on the "rental_identity" field.
func RentalIdentityNotNil() predicate.Account {
	return predicate.Account(sql.FieldNotNull(FieldRentalIdentity))
}

// RentalIdentityEqualFold applies the EqualFold predicate on the "rental_identity" field.
func RentalIdentityEqualFold(v string) predicate.Account {
	return predicate.Account(sql.FieldEqualFold(FieldRentalIdentity, v))
}

// RentalIdentityContainsFold applies the ContainsFold predicate on the "rental_identity" field.
func RentalIdentityContainsFold(v string) predicate.Account {
	return predicate.Account(sql.FieldContainsFold(FieldRentalIdentity, v))
}
