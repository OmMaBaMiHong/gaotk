...
export function createAccountsAPI(scope: AccountScope = 'admin') {
...
async function getUpstreamBillingRatesWithEtag(
  page: number = 1,
  pageSize: number = 20,
  filters?: {
    owner_user_id?: string | number
 ...
 */
async function create(accountData: CreateAccountRequest): Promise<Account> {
...
async function duplicate(id: number): Promise<Account> {
 ...
 */
async function update(id: number, updates: UpdateAccountRequest): Promise<Account> {
  const { data } = await apiClient.put<Account>(`/admin/accounts/${id}`, updates)
  return data
}

async function getGrokMediaEligibility(id: number): Promise<GrokMediaEligibilityState> {
...
async function updateGrokMediaEligibility(
  id: number,
 ...
 */
async function checkMixedChannelRisk(
 ...
 * @returns Updated account
 */
async function toggleStatus(id: number, status: 'active' | 'inactive'): Promise<Account> {
 ...
 * @returns Test result
 */
async function testAccount(id: number): Promise<{
  success: boolean
  message: string
  latency_ms?: number
}> {
...
async function refreshCredentials(id: number): Promise<RefreshCredentialsResult> {
 ...
 */
async function getStats(id: number, days: number = 30): Promise<AccountUsageStatsResponse> {
 ...
 * @returns Updated account
 */
async function clearError(id: number): Promise<Account> {
 ...
 */
async function getUsage(id: number, source?: 'passive' | 'active', force?: boolean): Promise<AccountUsageInfo> {
...
async function getBatchUsage(accountIds: number[], force?: boolean): Promise<BatchAccountUsageResponse> {
 ...
 * @returns Updated account
 */
async function clearRateLimit(id: number): Promise<Account> {
  const { data } = await apiClient.post<Account>(
 ...
 * @returns Updated account
 */
async function recoverState(id: number): Promise<Account> {
 ...
 * @returns Updated account
 */
async function resetAccountQuota(id: number): Promise<Account> {
  const { data } = await apiClient.post<Account>(
 ...
 */
async function getTempUnschedulableStatus(id: number): Promise<TempUnschedulableStatus> {
 ...
 * @returns Success confirmation
 */
async function resetTempUnschedulable(id: number): Promise<{ message: string }> {
 ...
 */
async function batchCreate(accounts: CreateAccountRequest[]): Promise<{
  success: number
  failed: number
 ...
 */
async function batchUpdateCredentials(request: {
  account_ids: number[]
  field: string
  value: any
}): Promise<{
 ...
 */
async function getTodayStats(id: number): Promise<WindowStats> {
 ...
 */
async function getBatchTodayStats(accountIds: number[]): Promise<BatchTodayStatsResponse> {
 ...
 * @returns Updated account
 */
async function setSchedulable(id: number, schedulable: boolean): Promise<Account> {
 ...
 */
async function getAvailableModels(id: number): Promise<ClaudeModel[]> {
 ...
 */
async function syncUpstreamModels(id: number): Promise<SyncUpstreamModelsResult> {
 ...
 * @returns List of model IDs returned by the upstream
 */
async function syncUpstreamModelsPreview(params: SyncUpstreamPreviewParams): Promise<SyncUpstreamModelsResult> {
...
async function previewFromCrs(params: {
  base_url: string
  username: string
  password: string
...
async function syncFromCrs(params: {
  base_url: string
  username: string
  password: string
...
async function importCodexSession(payload: CodexSessionImportRequest): Promise<CodexSessionImportResult> {
...
async function createOpenAICodexPAT(payload: OpenAICodexPATCreateRequest): Promise<Account> {
 ...
 */
async function getAntigravityDefaultModelMapping(): Promise<Record<string, string>> {
 ...
 * @returns Success confirmation
 */
async function revertProxyFallback(id: number): Promise<{ message: string }> {
 ...
 */
async function batchDelete(accountIds: number[]): Promise<BatchOperationResult> {
 ...
 */
async function batchClearError(accountIds: number[]): Promise<BatchOperationResult> {
 ...
 * @returns Batch operation result
 */
async function batchRefresh(accountIds: number[]): Promise<BatchOperationResult> {
 ...
 * @returns Updated account
 */
async function setPrivacy(id: number): Promise<Account> {
 ...
 * client binding here.
 */
async function refreshOpenAIQuota(id: number): Promise<OpenAIQuotaRefreshResult> {
...
async function refreshOpenAIReferrals(id: number): Promise<OpenAIReferralRefreshResult> {
...
async function sendOpenAIReferralInvite(
  id: number,
 ...
 */
async function resetOpenAIQuota(id: number): Promise<OpenAIQuotaResetResult> {
...
async function createSparkShadow(parentId: number, payload: SparkShadowCreatePayload): Promise<Account> {
  const { data } = await apiClient.post<Account>(`/admin/accounts/${parentId}/shadow`, payload)
  return data
}

async function getUpstreamBillingProbeSettings(): Promise<UpstreamBillingProbeSettings> {
  const { data } = await apiClient.get<UpstreamBillingProbeSettings>('/admin/accounts/upstream-billing-probe/settings')
  return data
}

async function updateUpstreamBillingProbeSettings(
...
async function setUpstreamBillingProbeEnabled(id: number, enabled: boolean): Promise<void> {
  await apiClient.put(`/admin/accounts/${id}/upstream-billing-probe`, { enabled })
}

async function probeUpstreamBilling(id: number): Promise<UpstreamBillingProbeResult> {
  const { data } = await apiClient.post<UpstreamBillingProbeResult>(`/admin/accounts/${id}/upstream-billing-probe`)
  return data
}

async function probeUpstreamBillingBatch(accountIds: number[]): Promise<UpstreamBillingProbeResult[]> {
...
async function getOllamaCloudUsageSettings(): Promise<OllamaCloudUsageSettings> {
  const { data } = await apiClient.get<OllamaCloudUsageSettings>('/admin/accounts/ollama-cloud-usage/settings')
  return data
}

async function updateOllamaCloudUsageSettings(
...
async function getOllamaCloudUsage(id: number): Promise<OllamaCloudUsageState> {
  const { data } = await apiClient.get<OllamaCloudUsageState>(`/admin/accounts/${id}/ollama-cloud-usage`)
  return data
}

async function saveOllamaCloudUsageSession(id: number, session: string): Promise<OllamaCloudUsageState> {
...
async function deleteOllamaCloudUsageSession(id: number): Promise<OllamaCloudUsageState> {
  const { data } = await apiClient.delete<OllamaCloudUsageState>(`/admin/accounts/${id}/ollama-cloud-usage/session`)
  return data
}

async function setOllamaCloudUsageAutoRefresh(id: number, enabled: boolean): Promise<OllamaCloudUsageState> {
...
async function refreshOllamaCloudUsage(id: number): Promise<OllamaCloudUsageState> {
  const { data } = await apiClient.post<OllamaCloudUsageState>(`/admin/accounts/${id}/ollama-cloud-usage/refresh`)
  return data
}

async function getOpenCodeGoUsageSettings(): Promise<OpenCodeGoUsageSettings> {
  const { data } = await apiClient.get<OpenCodeGoUsageSettings>('/admin/accounts/opencode-go-usage/settings')
  return data
}

async function updateOpenCodeGoUsageSettings(
...
async function getOpenCodeGoUsage(id: number): Promise<OpenCodeGoUsageState> {
  const { data } = await apiClient.get<OpenCodeGoUsageState>(`/admin/accounts/${id}/opencode-go-usage`)
  return data
}

async function setOpenCodeGoUsageAutoRefresh(id: number, enabled: boolean): Promise<OpenCodeGoUsageState> {
...
async function refreshOpenCodeGoUsage(id: number): Promise<OpenCodeGoUsageState> {
...
return { ...accountsAPI, deleteAccount, refreshOpenAIReferrals, sendOpenAIReferralInvite }
}
