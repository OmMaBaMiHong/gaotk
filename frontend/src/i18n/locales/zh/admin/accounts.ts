export default {
    accounts: {
      ...
      kimiOAuth: {
        connect: '连接 Kimi 坐席',
        start: '发起设备授权',
        startDesc: '点击开始获取一次性验证码。随后在 Kimi 页面完成授权，即可将企业坐席接入为 OAuth 账号。',
        waiting: '等待授权……请在新打开的页面登录并确认',
        userCodeLabel: '验证码',
        ...
        pollAgain: '再次检测',
        autoPolling: '自动检测中…',
        expiresIn: '验证码 {seconds} 秒后过期',
        expired: '验证码已过期，请重新生成',
        ready: '授权成功，可创建账号',
        accountName: '账号名称',
        accountNamePlaceholder: 'Kimi Code 坐席',
        createAccount: '创建账号',
        creating: '创建中…'
      },
      createAccount: '添加账号',
