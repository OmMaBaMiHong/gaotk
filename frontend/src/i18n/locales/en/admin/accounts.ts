export default {
    accounts: {
      ...
      kimiOAuth: {
        connect: 'Connect Kimi Seat',
        start: 'Start Device Authorization',
        startDesc: 'Click start to get a one-time verification code, then approve it on the Kimi page to connect your enterprise seat as an OAuth account.',
        waiting: 'Waiting for authorization… sign in and confirm on the newly opened page',
        userCodeLabel: 'Verification Code',
        openVerification: 'Open Verification Page',
        copyCode: 'Copy Code',
        copied: 'Copied',
        pollAgain: 'Check Again',
        autoPolling: 'Auto-checking…',
        expiresIn: 'Code expires in {seconds} seconds',
        expired: 'Code expired, please regenerate',
        ready: 'Authorization successful, you can create the account',
        accountName: 'Account Name',
        accountNamePlaceholder: 'Kimi Code Seat',
